...
contract Deploy is Script {
    ...
    bytes32 salt = 0x0000000000000000000000000000000000000000f258d58e690c700728f70d3b;

    function run() external {
        deployChain("base-goerli");
        // deployChain("polygon-mumbai");
        // deployChain("arbitrum-goerli");
        // deployChain("avalanche-fuji");
        // deployChain("optimism-goerli");
        // deployChain("goerli");
    }
