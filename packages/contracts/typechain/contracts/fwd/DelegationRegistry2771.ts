...
export interface DelegationRegistry2771Interface extends utils.Interface {
  functions: {
...
export interface DelegationRegistry2771 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DelegationRegistry2771Interface;
