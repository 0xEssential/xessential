...
var DelegationRegistryInterface_1 = require("./DelegationRegistryInterface");
...
var DelegationTree = /** @class */ (function () {
    function DelegationTree(provider, nftContract, tokenId, rootAddress) {
        ...
        this.Registry = new DelegationRegistryInterface_1.DelegationRegistryInterface(provider);
        this.rootNode = {
            address: rootAddress,
    ...
    DelegationTree.prototype.fetchAuthorizersAsync = function (node) {
        return __awaiter(this, void 0, void 0, function () {
            var allDelegations, validDelegations, promises, _validDelegations;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.Registry.getAllDelegations(node.address)];
                    case 1:
                        allDelegations = _a.sent();
                        console.warn('ALL DELEGATIONS: ', allDelegations);
                        validDelegations = allDelegations.filter(function (node) {
                            if (node.type_ === DELEGATION_TYPES.ALL)
                                return true;
                        ...
                        promises = validDelegations.map(function (delegation) { return __awaiter(_this, void 0, void 0, function () {
                            var vault;
                            var _this = this;
                            return __generator(this, function (_a) {
                                vault = delegation.vault;
                                // const nodeDelegated = await this.Registry.checkDelegateForToken(
                                //   node.address,
                                //   vault,
                                //   this.nftContract,
                                //   this.tokenId,
                    ...
                    case 2:
                        _validDelegations = (_a.sent()).filter(Boolean);
                        console.warn('VALID DELEGATIONS: ', allDelegations.map(function (d) { return ({
                            vault: d.vault,
                        }); }));
                        return [2 /*return*/, _validDelegations];
                }
            });
        });
    };
    DelegationTree.prototype.fetchCurrentOwner = function (provider, nftContract, tokenId) {
        return __awaiter(this, void 0, void 0, function () {
            var Erc721;
            return __generator(this, function (_a) {
