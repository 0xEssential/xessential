...
var OwnershipService = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6: return [2 /*return*/, this.generateProof(decodedCallData, owner, to)];
                }
            });
        });
    };
    OwnershipService.prototype.decodeCalldata = function (calldata) {
        ...
        var decoded = abi.decode(Object.values(rawCallDataType), calldata);
        return Object.keys(rawCallDataType).reduce(function (obj, key, index) {
            var _a;
    ...
    OwnershipService.prototype.generateProof = function (decodedCallData, owner, to) {
        return __awaiter(this, void 0, void 0, function () {
            var nftChainId, nftContract, nftTokenId, from, targetChainId, timestamp, targetProvider, forwarder, nonce, message, ownershipSigner;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        nftChainId = decodedCallData.nftChainId, nftContract = decodedCallData.nftContract, nftTokenId = decodedCallData.nftTokenId, from = decodedCallData.from, targetChainId = decodedCallData.targetChainId, timestamp = decodedCallData.timestamp;
                        ...
                        return [4 /*yield*/, forwarder.getNonce(from)];
                    case 1:
                        nonce = _a.sent();
                        if (!nonce.eq(nonce))
                            Promise.reject('Invalid nonce');
